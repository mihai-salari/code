...
class InterfaceController: WKInterfaceController {
    ...
    lazy var specialCharacterOnFont: NSAttributedString = {
        ...
        let attributes = [NSFontAttributeName: boldFont, NSForegroundColorAttributeName: textColor]
    ...
    lazy var specialCharacterOffFont: NSAttributedString = {
        ...
        let attributes = [NSFontAttributeName: normalFont, NSForegroundColorAttributeName: textColor]
        let text = NSAttributedString(string: "!@#$%", attributes: attributes)
